...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    I've made a couple of web apps in that language. Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/fredyrocxx" target="_blank">Github</a>!`,
  ...
  I also watch game programming tutorials on YouTube.
  ...
  resume: `This is my desk and on it is my resume. <a href="https://github.com/fredyrocxx/Resume/blob/main/Fredrose_Rebello_Resume.pdf" target="_blank">Check it out?</a>
  Contact me at fredroserebello@gmail.com if you have any interesting job opportunities!`,
